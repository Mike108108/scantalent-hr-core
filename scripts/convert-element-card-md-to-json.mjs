 ...
 * open_center_head JSON is maintained from approved source (open_center_head.v1.json).
 ...
 * gate_28 JSON is maintained from approved source (gate_28.v1.json).
 * gate_38 JSON is maintained from approved source (gate_38.v1.json).
 * gate_48 JSON is maintained from approved source (gate_48.v1.json).
 * gate_16 JSON is maintained from approved source (gate_16.v1.json).
 * gate_56 JSON is maintained from approved source (gate_56.v1.json).
 * gate_11 JSON is maintained from approved source (gate_11.v1.json).
 * gate_43 JSON is maintained from approved source (gate_43.v1.json).
 * gate_24 JSON is maintained from approved source (gate_24.v1.json).
 * gate_17 JSON is maintained from approved source (gate_17.v1.json).
 * gate_52 JSON is maintained from approved source (gate_52.v1.json).
 * gate_54 JSON is maintained from approved source (gate_54.v1.json).
 * gate_40 JSON is maintained from approved source (gate_40.v1.json).
 ...
 * activation_role Sun/Earth/Moon batch 1 JSON: use scripts/convert-activation-role-element-cards-md-to-json.py
 */
